...
class QueueFlowTest extends AbstractIntegrationTest {
    ...
    void queueJoin_registersInZSet() {
        ...
        Double score = redisTemplate.opsForZSet().score("event:waiting_queue", "100");
    ...
    void queueOrder_firstInFirstOut() throws InterruptedException {
        ...
        Set<String> ordered = redisTemplate.opsForZSet().range("event:waiting_queue", 0, -1);
    ...
    void scheduler_promotesUser() throws InterruptedException {
        ...
        Double score = redisTemplate.opsForZSet().score("event:waiting_queue", "200");
    ...
    void sse_receiveGoBookingViaScheduler() throws Exception {
        ...
        assertThat(redisTemplate.opsForZSet().score("event:waiting_queue", userId.toString())).isNull();
    }
